        ...
        <div className='cartPage'>
            {(props.productCart.length) ? <>
                        ...
                        return <>
                            <div className='OneProduct'>
                                ...
                                <div className='CartDetail'>
                                    ...
                                    <div><h4 className='product-category'><i class="fa-solid fa-tag"></i> {item.category}</h4></div>
                ...
                <div className='checkOutDiv'>
                    ...
                    <button onClick={printBill}>Check Out <i class="fa-solid fa-truck-fast fa-lg"></i></button>
                </div>
            </> : <>
